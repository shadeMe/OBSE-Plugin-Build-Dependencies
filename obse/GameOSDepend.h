...
public:
	...
	enum
	{
		kMusicFlags_HasFilterGraph			= 1 << 0,
		kMusicFlags_FilePlaying				= 1 << 1,
	};
	...
	IGraphBuilder*			filterGraph;				// 070
	IBasicAudio*			basicAudioInterface;		// 074
	...
	UInt32					unk0DC;						// 0DC
	UInt32					unk0E0[(0x1E4-0x0E0) >> 2];	// 0E0
	char					musicFileName[MAX_PATH];	// 1E4
	UInt32					tickCount;					// 2E8 - updated with the global game timer's value
	UInt32					unk2EC;						// 2EC - set to tickCount + 1700
